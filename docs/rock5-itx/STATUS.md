...
firmware-described 702 MHz SPLL source selected without division; a conservative
clock and bounded power/identity cycle are next. Haiku GPU execution and
