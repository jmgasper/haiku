...
driver work is deferred at the owner's request. The +195 USB image passes all
...
errors; each reports 14 cumulative receive drops. This is a link observation,
not a new throughput test. Evidence:
`artifacts/link-observation/20260915T030857Z/result.json`.
