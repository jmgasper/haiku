...
and independent eMMC/recovery-image integrity pass. These VMs are not yet activated
for application work. Persistent firmware, groups, queues, heaps, synchronization,
in-flight hardware retention, Mesa rendering and acceleration remain pending.
