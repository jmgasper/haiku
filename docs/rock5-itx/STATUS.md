...
the ARM64 build and both two-boot QEMU modes pass. GPU VM mapping, in-flight
buffer retention, application submission, Mesa rendering and acceleration remain
pending. The installed SSD's qualification status is unchanged.
