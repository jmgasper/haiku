...
component and native resource interface pass 130 host tests, ARM64 build,
...
reboot and independent recovery/storage integrity. The next Haiku diagnostic
observes inherited clock/power registers without writing them or accessing the
GPU. Haiku GPU execution and accelerated rendering remain pending.
