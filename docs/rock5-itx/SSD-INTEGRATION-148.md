# Earlier +148 SSD integration

This is the historical `+148` checkpoint. The current installed baseline and
later PCIe fix are recorded in [SSD-INTEGRATION.md](SSD-INTEGRATION.md) and
[PCIE-TRAINING.md](PCIE-TRAINING.md). Statements below describe that earlier run.
