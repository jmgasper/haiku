...
int main(int argc, char** argv)
{
	...
	CHECK(baseline.capabilities == (kClientCpuBuffers | kClientVmMappings | kClientQueues | kClientSynchronization | kClientHeaps | kClientProperties) && baseline.bufferCount == 0);
